...
| medium | `MCP-CONFIG-NPX-LATEST` | `mcp.json:10` | MCP server 'npx-demo' runs npx with automatic yes. |
...
- `MCP-CONFIG-NPX-LATEST` at `mcp.json:10`: Pin package versions and review the resolved package before using npx -y in shared configs.
